...
def build_command_context(command: str, args: str, context=None) -> str:
    ...
    # Requirement (user, 2026-07-02): ALL slash commands — including plugin
    # colon-namespaced ones — must go through Skill(). The Skill() event is
    # load-bearing for the PreToolUse/Stop gates and execution tracking, even
    # when the CLI already injected the SKILL.md content.
